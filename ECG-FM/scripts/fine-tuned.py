...
segmented_split['path'] = ('/home/datasets/code_15/segmented/') + segmented_split['path']
segmented_split.to_csv(os.path.join('/home/datasets/code_15/segmented_split.csv'))
...
model_path = f"/home/playground/ECG-FM/experiments/subset/5/checkpoint8.pt"
...
with open(f"/home/playground/ECG-FM/results/finetuned/finetuned-results-{run}.txt", "w") as f:
